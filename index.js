...
app.use(express.static(path.join(`D:/Naz'sCollectrion_API/Naz'sCollection_Website/my-app/build`)));

app.get('*' , (req , res) => {
   res.sendFile(path.join(`D:/Naz'sCollectrion_API/Naz'sCollection_Website/my-app/build/index.html`))
})
